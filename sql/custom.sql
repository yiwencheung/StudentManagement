...
INSERT INTO `sys_menu` VALUES (102, '菜单管理', 1, 3, 'menu', 'system/menu/index', '', 1, 0, 'C', '0', '0', 'system:menu:list', 'tree-table', 'admin', '2023-04-25 12:34:45', 'admin', '2023-04-30 19:36:28', '菜单管理菜单');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'admin', 1, '1', 1, 1, '0', '0', '0', 'admin', '2023-04-25 12:34:45', '', NULL, '超级管理员');
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', 0, 0, '0', '0', '0', 'admin', '2023-04-25 12:34:45', 'admin', '2023-04-30 16:13:44', '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', '系统管理员', '00', 'ysir@163.com', '18918918918', '0', '/profile/avatar/2023/04/30/blob_1652690097477255168.', '$2a$10$2bXKM4SmGcCONOfbEqvm2.uStFeUpOUwgXJ.hLTXZ.x7FziK9avze', '0', '0', '0', '127.0.0.1', '2023-04-28 17:16:15', 'admin', '2023-04-25 12:34:45', '', '2023-04-30 23:03:37', '管理员');
INSERT INTO `sys_user` VALUES (2, 'customer', '用户', '00', 'customer@qq.com', '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '0', '127.0.0.1', '2023-04-25 12:34:45', 'admin', '2023-04-25 12:34:45', '', NULL, '测试员');
