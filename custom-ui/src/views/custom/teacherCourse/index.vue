    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['custom:teacherCourse:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['custom:teacherCourse:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['custom:teacherCourse:remove']"
        >删除</el-button>
      </el-col>
...
<el-form-item label="教师名称" prop="teacherName">
<el-select v-model="form.teacherName" placeholder="请选择教师名称">
    <el-option
...
<script>
import { listTeacherCourse, getTeacherCourse, delTeacherCourse, addTeacherCourse, updateTeacherCourse } from "@/api/custom/teacherCourse";
import { listUser} from "@/api/custom/user";
import { listCourse} from "@/api/custom/course";
export default {
  name: "TeacherCourse",
  data() {
    return {
      ...
      rules: {
        ...
        studentNum: [
          { required: true, message: "可容纳学生数不能为空", trigger: "blur" }
        ],
        selectedNum: [
          { required: true, message: "已选择学生数不能为空", trigger: "blur" }
        ],
        createTime: [
