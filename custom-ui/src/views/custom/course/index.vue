  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程性质" prop="typeName">
        <el-input v-model="queryParams.typeName" placeholder="请输入课程性质" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="学分" prop="credit">
        <el-input type="number" v-model="queryParams.credit" placeholder="请输入学分" clearable
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['custom:course:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['custom:course:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['custom:course:remove']">删除</el-button>
      </el-col>
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程性质" prop="typeName">
          <el-select @change="selectCourseTypeChange" v-model="form.typeName" placeholder="请选择课程性质">
            <el-option v-for="(item,index) in typeNameList" :label="item.name" :value="index">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="总学时" prop="name">
          <el-input type="number" v-model="form.totalPeriod" placeholder="请输入总学时" />
        </el-form-item>
        <el-form-item label="授课学时" prop="name">
          <el-input type="number" v-model="form.teachingPeriod" placeholder="请输入授课学时" />
        </el-form-item>
        <el-form-item label="上机学时" prop="name">
          <el-input type="number" v-model="form.computerPeriod" placeholder="请输入上机学时" />
        </el-form-item>
        <el-form-item label="实验学时" prop="name">
          <el-input type="number" v-model="form.experimentalPeriod" placeholder="请输入实验学时" />
        </el-form-item>
        <el-form-item label="学分" prop="name">
          <el-input type="number" v-model="form.credit" placeholder="请输入学分" />
        </el-form-item>
