  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['custom:studentCourse:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['custom:studentCourse:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['custom:studentCourse:remove']"
        >删除</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item
                label="学生编号" prop="userId">
          <el-input v-model="form.userId" placeholder="请输入学生编号" />
        </el-form-item>
        <el-form-item
...
<script>
import { listStudentCourse, getStudentCourse, delStudentCourse, addStudentCourse, updateStudentCourse } from "@/api/custom/studentCourse";
import { listTeacherCourse} from "@/api/custom/teacherCourse";
export default {
  name: "StudentCourse",
  data() {
    return {
       ...
       courseNameList: [],
       //考试状态
       examStatusList: [{"label":"未开始","value":"0"},{"label":"已考试","value":"1"}],
       //支付状态
       payStatusList: [{"label":"未支付","value":"0"},{"label":"已支付","value":"1"},{"label":"已取消","value":"2"}],
      // 遮罩层
      loading: true,
        isEdit:false,
      // 选中数组
      ...
      rules: {
        ...
        examStatus: [
          { required: true, message: "考试状态不能为空", trigger: "change" }
        ],
        payStatus: [
